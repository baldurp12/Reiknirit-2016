/******************************************************************************
 *  Compilation:  javac RectHVreference.java
 *  Execution:    none
...
/**
 *  The <tt>RectHVreference</tt> class is an immutable data type to encapsulate a
...
public final class RectHVreference {
     ...
     */
    public RectHVreference(double xmin, double ymin, double xmax, double ymax) {
     ...
     */
    public boolean intersects(RectHVreference that) {
    ...
    public boolean equals(Object other) {
        ...
        RectHVreference that = (RectHVreference) other;
